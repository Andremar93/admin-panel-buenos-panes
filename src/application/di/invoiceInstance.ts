...
import { PayInvoiceUseCase } from '@/application/use_case/invoice/PayInvoiceUseCase';
import { EraseInvoiceUseCase } from '@/application/use_case/invoice/EraseInvoiceUseCase';
...
export const eraseInvoiceUseCase = new EraseInvoiceUseCase(repository);
