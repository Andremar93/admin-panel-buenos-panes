    ...
    return (
        <div style={{ flex: 1, paddingLeft: 20 }}>
            <div className="mb-6 p-4 bg-yellow-50 border border-yellow-300 rounded-xl shadow-sm">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm text-yellow-900">
                    <div>
                        Total Ilegal:  <FormattedAmount amount={totals.efectivoDolares + totals.efectivoBsUSD + totals.puntoExternoUSD} currency="USD" />
                    </div>
                    <div>
            ...
            <h2 className="text-xl font-bold text-gray-800 mb-4">Ingresos:</h2>
            ...
            <ul className="space-y-4">
                {incomes.map((income) => {
                    ...
                    return (
                        <li key={income._id} className="bg-white p-4 rounded-xl shadow space-y-2 text-sm text-gray-800">
